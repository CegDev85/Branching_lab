...
class CompoundInterestTest(unittest.TestCase):
    ...
    def test_100_at_5_for_10_contributing_1000(self):
        self.assertEqual(156093.99, self.interest_calculator.calculate_with_cont(100, 0.05, 10, 1000))

    # Should return 475,442.59 given 116028.86, 7.5 percent, 8 years, 2006 per month
    def test_100_at_5_for_10_contributing_1000(self):
        self.assertEqual(475442.59, self.interest_calculator.calculate_with_cont(116028.86, 0.075, 8, 2006))
